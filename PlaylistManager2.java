...
public class PlaylistManager2 {
    ...
    public static void logAction(String action, String song) {

        try {

            FileWriter fw = new FileWriter("playlist_log.txt", true);

            BufferedWriter bw = new BufferedWriter(fw);

            bw.write(LocalDateTime.now() + " - " + action + " - " + song);
